...
class ProformaInvoice extends Component<IProps> {

    downloadProformaInvoice = () => {
        if (this.props.invoice.proformaUrl) {
            window.open(this.props.invoice.proformaUrl, "_blank");
        }
    };
            ...
            <Container className="px-2 py-3" fluid>
                    ...
                    <Col xs={12} md={8} className="mt-16px md-mt-0px">
                        <div className="row ml-0px float-right">
                            <GologsButton
                                ...
                                className="mr-2 mb-10px md-mb-0px"
                                content={
                                    <>
                                        <GeneralTranslation
                                            slug="view"
                ...
                <Row>
                    <Col xs={12}>
                        <div className="fs-24px font-weight-light-bolder text-primary-gray">
                            ...
                            <span> - </span>
                            <span>{this.props.terminalOperator.value}</span>
                        </div>
                    </Col>
                </Row>
                ...
                <Row className="mt-2">
                    <Col xs={12} md={6} className="pl-5">
                        <div className="fs-18px text-black pl-2">
                            <GeneralTranslation slug="SP2.service" />
                        </div>
                    </Col>
                    <Col xs={12} md={6}>
