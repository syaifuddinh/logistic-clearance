...
export default class SP2DelegateSuccess extends React.Component {
    state = {
        isRedirect: false,
    ...
    getContent = props => {
                                ...
                                <Col xs={6}>
                                    <div>
                                        <h2 className="font-weight-bolder">
                                            <GeneralTranslation slug="SP2.delegate" />
                                        </h2>
                                        <h2 className="font-weight-bolder">
        ...
        return (
            ...
            <>
                ...
                <Sidebar
                header-name={t(translations.SP2.title)}
                />
                {content}
            </>
            </>
