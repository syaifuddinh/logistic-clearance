...
import Depo from "../../../../../endpoints/Master/Depo";
...
export default class List extends React.Component {
    ...
    onSubmit = async (id = null) => {
        ...
        try {
            ...
            if (id) {
                dt = await Depo.update(this.state.data, id);
            } else {
                dt = await Depo.store(this.state.data);
            }
            this.setState({data: {}})
            this.refreshTable();
        } catch(e) {
    ...
    componentDidMount() {
        ...
        breadcrumbs = [
            ...
            {
                name: <GeneralTranslation slug="sidebarMenu.depo" />
            }
        ];
        this.setState({breadcrumbs: breadcrumbs});

        table.columnDefs = [
            { title: <GeneralTranslation slug="depoName" />},
                        ...
                        <Col className="px-3 pt-4  d-flex justify-content-between align-items-center">
                            <div className="d-inline-block">
                                <h4 className="font-weight-bold d-inline-block mb-0 text-capitalize">
                                    <GeneralTranslation slug="sidebarMenu.depo" />
                                </h4>
